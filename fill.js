...
// ####################################################################################################################
// ########## СОХРАНЕНИЕ ПРОГНОЗОВ В LOCALSTORAGE ##########
// ####################################################################################################################
...
// ####################################################################################################################
// ########## ФОРМАТИРОВАНИЕ ИМЕНИ УЧАСТНИКА ##########
// ####################################################################################################################
...
// ####################################################################################################################
// ########## ПОИСК СВОБОДНОЙ КОЛОНКИ ДЛЯ ЗАПИСИ ПРОГНОЗОВ ##########
// ####################################################################################################################
...
// ####################################################################################################################
// ########## ПРОВЕРКА СУЩЕСТВОВАНИЯ ИМЕНИ В ТАБЛИЦЕ ##########
// ####################################################################################################################
...
// ####################################################################################################################
// ########## ФОРМАТИРОВАНИЕ СЧЕТА В ВИД "Х:Х" ##########
// ####################################################################################################################
...
// ####################################################################################################################
// ########## ПАРСИНГ СЧЕТА ИЗ РАСПОЗНАННОЙ РЕЧИ ##########
// ####################################################################################################################
...
// ####################################################################################################################
// ########## ОТКРЫТИЕ МОДАЛЬНОГО ОКНА ДЛЯ ВВОДА ПРОГНОЗА ##########
// ####################################################################################################################
...
// ####################################################################################################################
// ########## ГОЛОСОВОЙ ВВОД ПРОГНОЗА В МОДАЛЬНОМ ОКНЕ ##########
// ####################################################################################################################
...
// ####################################################################################################################
// ########## ЗАПОЛНЕНИЕ ВСЕХ ПРОГНОЗОВ СЛУЧАЙНЫМИ СЧЕТАМИ ##########
// ####################################################################################################################
function fillRandom() {
...
// ####################################################################################################################
// ########## ОТПРАВКА ВСЕХ ПРОГНОЗОВ НА СЕРВЕР ##########
// ####################################################################################################################
